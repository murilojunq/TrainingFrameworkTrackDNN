...
def get_isoFR_point(column, column2, df_tot, iteration="InitialStep"):
        ...
        originalWPs=qualityCutDictionary[iteration]#trackdnn_CKF[iteration]  
        newWPs=[]
        origEffs=[]
        newEffs=[]
...
for process in ["RelValTTbar"]:#['DisSUSY2', 'DisSUSY3', 'DisSUSY4', 'QCD1', 'ZToEE1',]:#'TT', 'DisSUSY1', 'DisSUSY2', 'DisSUSY3', 'DisSUSY4', 'QCD1', 'ZToEE1',]:
        ...
        #make model
        print("Found it")
        #stored_model = tf.keras.models.load_model("retrain-ALL-CKF125-OLDFiles_v2/modelTEST-04/model/")#("result_minxi/CKF_final/model")
        stored_model = tf.keras.models.load_model("retrain-ALL-MKFIT125-OLDFiles_v2/modelTEST-03")
        #predict
        ...
        columnOLD="new_MVA2"
         ...
         #make model
        print("Found it")
        #stored_model2 = tf.keras.models.load_model("result_minxi/CKF_final/model")
        ...
        get_isoEff_fromEff(columnOLD, column, df_tot, iteration="LowPtQuadStep")
        get_isoEff_fromEff(columnOLD, column, df_tot, iteration="LowPtTripletStep")
        get_isoEff_fromEff(columnOLD, column, df_tot, iteration="PixelLessStep")
