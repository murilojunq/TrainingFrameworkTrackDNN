...
for process in ["TrainTTbar"]:#['DisSUSY2', 'DisSUSY3', 'DisSUSY4', 'QCD1', 'ZToEE1',]:#'TT', 'DisSUSY1', 'DisSUSY2', 'DisSUSY3', 'DisSUSY4', 'QCD1', 'ZToEE1',]:
        ...
        #make model
        print("Found it")
        stored_model = tf.keras.models.load_model("retrain-ALL-CKF125-OLDFiles/modelTEST-00/model/")#("result_minxi/CKF_final/model")
